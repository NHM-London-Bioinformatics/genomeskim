...
process GOFETCH {
    ...
    conda (params.enable_conda ? "conda-forge::biopython=1.81 bioconda::getorganelle=1.7.7.1 bioconda::trf=4.07b-0" : null)
    ...
    wget -O go_fetch.py https://raw.githubusercontent.com/o-william-white/go_fetch/main/go_fetch.py
